...
import com.youset.l2cache.cache.expire.DefaultCacheExpiredListener;
import com.youset.l2cache.CacheBuilder;
import com.youset.l2cache.CacheConfig;
import com.youset.l2cache.content.CacheSupport;
import com.youset.l2cache.spi.ServiceLoader;
...
public class L2CacheCacheManager implements CacheManager {
    ...
    protected Cache createL2CacheSpringCache(String cacheType, String cacheName) {
        ...
        com.youset.l2cache.Cache cache = this.getL2CacheInstance(cacheType, cacheName, expiredListener);
     ...
     */
    private com.youset.l2cache.Cache getL2CacheInstance(String cacheType, String cacheName, CacheExpiredListener expiredListener) {
        com.youset.l2cache.Cache cache = CacheSupport.getCache(cacheType, cacheName);
        if (null != cache) {
            return cache;
        }
